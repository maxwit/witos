...
static int __INIT__ at91_nand_init(void)
{
	...
	writel(VA(AT91SAM926X_PA_PMC + PMC_PCER), 1 << PID_PIOA | 1 << PID_PIOD);

	writel(VA(AT91SAM926X_PA_PIOD + PIO_PER), PIO_NAND_CE);
	writel(VA(AT91SAM926X_PA_PIOD + PIO_OER), PIO_NAND_CE);
	writel(VA(AT91SAM926X_PA_PIOD + PIO_CODR), PIO_NAND_CE);

	writel(VA(AT91SAM926X_PA_PIOA + PIO_PER), PIO_NAND_RDY);
	writel(VA(AT91SAM926X_PA_PIOA + PIO_ODR), PIO_NAND_RDY);
	writel(VA(AT91SAM926X_PA_PIOA + PIO_PUER), PIO_NAND_RDY);
