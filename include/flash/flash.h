...
typedef enum
{
	...
	PT_BL_GB_CONF,
	PT_BL_UBOOT,
	PT_OS_LINUX = PT_BL_GTH + 0x100,
	PT_OS_WINCE,
	PT_FS_RAMDISK = PT_OS_LINUX + 0x100,
...
struct flash_chip
{
	...
	struct part_attr  *attr; // fixme: struct partition
...
BOOL flash_set_ecc_mode(struct flash_chip *flash, ECC_MODE newMode, ECC_MODE *pOldMode);
